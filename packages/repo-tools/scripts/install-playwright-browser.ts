#!/usr/bin/env node
/**
 * Installs Playwright's Chromium browser for local end-to-end tests after npm
...
console.log('Installing Playwright Chromium for end-to-end tests...');
...
if (result.status !== 0) {
  ...
  console.error('Playwright Chromium install failed. Run `npm run test:e2e:install` to retry.');
