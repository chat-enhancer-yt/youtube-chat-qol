export const controls = {
  ...
  bookmarksBrowseControls: document.querySelector<HTMLElement>('#bookmarksBrowseControls'),
  bookmarksSelect: document.querySelector<HTMLButtonElement>('#bookmarksSelect'),
  bookmarksSelectionControls: document.querySelector<HTMLElement>('#bookmarksSelectionControls'),
  bookmarksCancelSelection: document.querySelector<HTMLButtonElement>('#bookmarksCancelSelection'),
  bookmarksSelectionCount: document.querySelector<HTMLElement>('#bookmarksSelectionCount'),
  bookmarksSelectAll: document.querySelector<HTMLButtonElement>('#bookmarksSelectAll'),
  bookmarksRemoveSelected: document.querySelector<HTMLButtonElement>('#bookmarksRemoveSelected'),
  bookmarksUndo: document.querySelector<HTMLElement>('#bookmarksUndo'),
  bookmarksUndoCount: document.querySelector<HTMLElement>('#bookmarksUndoCount'),
  bookmarksUndoButton: document.querySelector<HTMLButtonElement>('#bookmarksUndoButton'),
